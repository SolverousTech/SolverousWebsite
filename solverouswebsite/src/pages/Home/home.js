  ...
  return (
    <>
      <main>
        ...
        {/* FAQs Section */}
        <section id="faqs" style={faqsBg} className=" flex flex-col md:flex-col lg:flex-row xl:flex-row justify-center items-center bg-no-repeat bg-cover bg-center h-[110vh] sm:h-[105vh] md:h-[63vh] lg:h-[90vh] xl:h-[92vh] 2xl:h-[57vh] space-y-0 sm:space-y-[-2rem] md:space-y-10 lg:space-y-0 ">
