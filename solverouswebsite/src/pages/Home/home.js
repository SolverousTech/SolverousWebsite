      ...
      <main>
        ...
        <section id="home" style={homeBg} className=" bg-no-repeat bg-cover bg-center h-[95vh] md:h-[70vh] lg:h-[95vh] content-center space-y-4 md:space-y-5 lg:space-y-6 ">
          <div className=" space-y-1 md:space-y-2 lg:space-y-3 ">
            <h1 className=" font-bold text-white text-[2rem] md:text-3xl lg:text-3xl xl:text-4xl 2xl:text-5xl body_margin flex flex-col w-fit [text-shadow:0_4px_6px_rgba(1,0,0,0.5)] ">YOUR VISION, <span className="text-[#ffffff]">OUR INNOVATION</span></h1>
