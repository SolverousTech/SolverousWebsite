      ...
      <main>
          ...
          <div className=" space-y-6 md:space-y-7 lg:space-y-7 xl:space-y-3 2xl:space-y-5 w-full md:w-full lg:w-full xl:w-[75%] 2xl:w-[75%] text-center md:text-left ">
            ...
            <div className=" space-y-8 md:space-y-4 lg:space-y-4">
              ...
              <div className="reasons_flex reasons_space_between items-center scale_animation w-fit">
                <div className=" reasons_icon_container reasons_icon_size w-[4rem] md:w-[8.5rem] lg:w-[10rem] xl:w-[8.5rem] 2xl:w-[17.5rem] "><img src={Automation} alt="Automation" /></div>
                <div>
              ...
              {/* SECOND REASON */}
              <div className="reasons_flex reasons_space_between items-center scale_animation w-fit ">
                <div className="reasons_icon_container reasons_icon_size w-[4rem] md:w-[11.3rem] lg:w-[13rem] xl:w-[11.2rem] 2xl:w-[22.5rem] "><img src={Target} alt="Target" /></div>
                <div>
              ...
              <div className=" reasons_flex reasons_space_between items-center scale_animation ">
                <div className="reasons_icon_container reasons_icon_size w-[4rem] md:w-[8rem] lg:w-[9.5rem] xl:w-[8.3rem] 2xl:w-[17rem] "><img src={Scaling} alt="Scaling" /></div>
                <div >
        ...
        <section id="about-us" className=" body_margin text-center content-center space-y-8 md:space-y-10 my-12 md:my-16 ">
          <div className=" flex flex-col justify-center items-center text-center space-y-2 md:space-y-2">
            <h3 className="text-[1.5rem] md:text-3xl lg:text-3xl xl:text-[2rem] 2xl:text-[2.5rem] font-bold text-[#004D8C] ">About <span className="text-[#007EE6]">Us</span></h3>
          ...
          <div className="flex flex-col md:flex-col lg:flex-col xl:flex-row 2xl:flex-row space-x-0 md:space-x-0 lg:space-x-7 xl:space-x-7 2xl:space-x-7 space-y-10 md:space-y-10 lg:space-y-0 xl:space-y-0 2xl:space-y-0">
            <div className=" w-full md:w-full lg:w-full xl:w-[71%] 2xl:w-[47%] h-full ">
        ...
        {/* 7TH SECTION */}
        <section style={peopleInMeeting} className=" bg-no-repeat bg-cover bg-center h-[50vh] md:h-[30vh] lg:h-[50vh] xl:h-[50vh] 2xl:h-[40vh] text-center content-center space-y-8 ">
          <div className=" flex flex-col justify-center items-center text-center space-y-4 md:space-y-4">
            <h3 className="text-[1.5rem] md:text-3xl lg:text-3xl xl:text-[2rem] 2xl:text-[2.5rem] font-bold text-white flex flex-col ">Transforming Ideas Into <span className="text-[#0889f1]">Digital Solutions</span></h3>
        ...
        {/* FAQs Section */}
        <section id="faqs" style={faqsBg} className=" flex flex-col md:flex-col lg:flex-row xl:flex-row justify-center items-center bg-no-repeat bg-cover bg-center h-[110vh] sm:h-[105vh] md:h-[63vh] lg:h-[90vh] xl:h-[92vh] 2xl:h-[57vh] space-y-1 sm:space-y-[-2rem] md:space-y-10 lg:space-y-0 ">
